$("#bronze-button").click(function() {
    ...
    $(".table-row").filter(function() {
        $(this).toggle($(this).text().toLowerCase().indexOf("praca") > -1)
    });
});
...
$("#silver-button").click(function() {
    ...
    $(".table-row").filter(function() {
        $(this).toggle($(this).text().toLowerCase().indexOf("zasiłek") > -1)
    });
});
...
$("#gold-button").click(function() {
    ...
    $(".table-row").filter(function() {
        $(this).toggle($(this).text().toLowerCase().indexOf("lokata") > -1)
    });
});
